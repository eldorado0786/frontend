...
// // import { Search, Menu, X, ThumbsUp, Video, HelpCircle, Settings } from "lucide-react";

// // // const PlayHeader = () => {
// // //   return (
// // //     <div>
// // //       <div className="h-screen overflow-y-auto bg-black text-white">
// // //         <header className="sticky inset-x-0 top-0 z-50 w-full border-b border-white bg-black px-4">
...
// // //             <Button variant="ghost" className="ml-auto sm:hidden" size="icon">
// // //               <Search className="h-6 w-6" />
// // //             </Button>

// // //             {/* Mobile menu button */}
// // //             <Button variant="ghost" className="group peer ml-4 flex w-6 shrink-0 flex-col gap-y-1.5 sm:hidden" size="icon">
// // //               <span className="block h-0.5 w-full bg-white group-hover:bg-purple-400"></span>
// // //               <span className="block h-0.5 w-2/3 bg-white group-hover:bg-purple-400"></span>
// // //               <span className="block h-0.5 w-full bg-white group-hover:bg-purple-400"></span>
// // //             </Button>

// // //             {/* Mobile slide-in menu */}
// // //             <Card className="fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 translate-x-full flex-col border-l border-white bg-black duration-200 hover:translate-x-0 peer-focus:translate-x-0 sm:static sm:ml-4 sm:w-auto sm:translate-x-0 sm:border-none sm:bg-transparent">
...
// // //                   </svg>
// // //                 </span>
// // //                 <Button variant="ghost" size="icon" className="inline-block w-8">
// // //                   <X className="h-6 w-6" />
// // //                 </Button>
// // //               </div>

// // //               {/* Mobile menu items */}
// // //               <CardContent className="my-4 flex w-full flex-wrap gap-2 px-4 sm:hidden">
// // //                 <Button variant="outline" className="flex w-full items-center justify-start gap-x-4 border border-white px-4 py-1.5 text-left hover:bg-purple-500 hover:text-black">
...
// // //                 <Button variant="secondary" className="w-full bg-zinc-800 px-3 py-2 hover:bg-zinc-700 sm:w-auto sm:bg-transparent">
// // //                   Log in
// // //                 </Button>
// // //                 <Button variant="default" className="mr-1 w-full bg-purple-500 px-3 py-2 text-center font-bold text-black shadow-md transition-all duration-150 ease-in-out hover:bg-purple-400 sm:w-auto">
// // //                   Sign up
// // //                 </Button>
// // //               </div>
// // //             </Card>
...
// import { Button } from "@/components/ui/button";
// import { Card, CardContent } from "@/components/ui/card";
// import { Search, X, ThumbsUp, Video, HelpCircle, Settings } from "lucide-react";
...
//           <Button
//             variant="ghost"
//             className="group ml-4 flex w-6 shrink-0 flex-col gap-y-1.5 sm:hidden"
//             size="icon"
//             onClick={toggleMenu}
//           >
//             <span className="block h-0.5 w-full bg-white group-hover:bg-purple-400"></span>
...
//           {/* Mobile slide-in menu - using state instead of hover/focus */}
//           <div className={`fixed inset-y-0 right-0 z-50 flex w-full max-w-xs shrink-0 flex-col border-l border-white bg-black transition-transform duration-300 sm:static sm:ml-4 sm:w-auto sm:transform-none sm:border-none sm:bg-transparent ${menuOpen ? 'translate-x-0' : 'translate-x-full sm:translate-x-0'}`}>
//             <div className="relative flex w-full items-center justify-between border-b border-white px-4 py-2 sm:hidden">
//               <span className="inline-block w-12">
//                 <svg
//                   className="w-full"
...
//                 </svg>
//               </span>
//               <Button variant="ghost" size="icon" className="inline-block w-8" onClick={toggleMenu}>
//                 <X className="h-6 w-6" />
//               </Button>
//             </div>

//             {/* Mobile menu items */}
//             <div className="my-4 flex w-full flex-wrap gap-2 px-4 sm:hidden">
//               <Button variant="outline" className="flex w-full items-center justify-start gap-x-4 border border-white px-4 py-1.5 text-left hover:bg-purple-500 hover:text-black">
//                 <ThumbsUp className="h-5 w-5" />
//                 <span>Liked Videos</span>
//               </Button>
