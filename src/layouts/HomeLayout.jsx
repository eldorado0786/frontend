...
//         <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
//           {/* Sidebar */}
//           <aside className="group fixed inset-x-0 bottom-0 z-40 w-full border-t border-white bg-[#121212] sm:absolute sm:inset-y-0 sm:w-[70px] lg:sticky lg:w-[250px]">
//             {/* ... sidebar content ... */}
//             <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
//               <li className="">
//                 <button className="flex flex-col items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:w-full sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff] sm:focus:text-black sm:group-hover:justify-start sm:group-hover:px-4 lg:justify-start lg:px-4">
...
//           <main className="w-full pb-16 sm:ml-[70px] sm:pb-0 lg:ml-[250px]">
//             {/* Add top padding to account for header height */}
//             <div className="p-4 pt-[66px] sm:pt-[82px]">
//               <Outlet />
//             </div>
//           </main>
//         </div>
